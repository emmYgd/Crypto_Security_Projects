...
public interface ServerCertPrimUtils extends ServerCertPrim {

    //get certificate building components here:
    default X509Certificate generateCert(String IssuerFirst_LastName, String IssuerOrgUnit,
    ...
    default HashMap<Object, Object> getCertComponents(X509Certificate UniqueCert) throws
